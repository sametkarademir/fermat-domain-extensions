...
namespace Fermat.Domain.Extensions.HttpContexts;
...
public static class HttpContextExtensions
{
    ...
    public static (bool IsMobile, bool IsDesktop, bool IsTablet) GetDeviceType(DeviceInfo deviceInfo)
    {
    ...
    /// </code>
    /// </example>
    public static async Task<string> GetRequestBodyAsync(this HttpContext context, int maxLength = 1000)
    {
    ...
    /// </code>
    /// </example>
    public static async Task<string> GetRequestBodyToJsonAsync(this HttpContext context)
    {
